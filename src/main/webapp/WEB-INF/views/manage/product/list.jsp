        ...
        <div class="card-body">
            <form method="get" action="/product" class="row g-3 align-items-end">
                ...
                <div class="col-md-12 d-flex justify-content-end gap-2 mt-3">
                    ...
                    <a href="/product?page=1" class="btn btn-secondary d-flex align-items-center px-3 shadow-sm">
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-body">
            ...
            <c:if test="${not empty filters}">
                <c:set var="context"
                       value="&action=filters&keyword=${filters.keyword}&minPrice=${filters.minPrice}&maxPrice=${filters.maxPrice}&category=${filters.category}&status=${filters.status}"/>
            </c:if>
            <nav>

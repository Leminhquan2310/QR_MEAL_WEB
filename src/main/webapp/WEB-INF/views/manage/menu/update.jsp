    ...
    <div class="card shadow-sm p-4">
        <form action="/menu" method="post" id="menuForm" class="row">
            ...
            <div class="mb-3 col-md-8">
                ...
                <select name="products" id="products" multiple>
                    <c:forEach var="p" items="${products}">
                        <option value="${p.id}" ${selectedProductIds.contains(p.id) ? "selected" : ""}> ${p.name} </option>
                    </c:forEach>
                </select>
            </div>
            ...
            <div class="mb-3 col-md-12">
                ...
                <textarea name="description" class="form-control" rows="2">${menu.description}</textarea>
            </div>
